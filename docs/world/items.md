...
| ID | 名称 | 分类 | 价格 | 出售价 | 效果 |
| --- | --- | --- | --- | --- | --- |
| `qiushi_planner` | 求是日程本 | 学习 | 90 | 45 | IQ +4，压力 -3 |
| `blue_lake_thermos` | 启真湖保温杯 | 生活 | 70 | 35 | 精力 +8，心态 +2 |
| `cc98_archive_key` | CC98 旧帖索引 | 社交 | 110 | 默认 50% | EQ +5，魅力 +3，声望 +3 |
| `silent_library_pass` | 图书馆静音席位卡 | 学习 | 130 | 65 | IQ +6，效率 +5，压力 +2 |
| `campus_bike_coupon` | 校园单车月卡 | 生活 | 85 | 默认 50% | 精力 +5，压力 -5 |
| `club_badge` | 社团联名徽章 | 社交 | 100 | 50 | EQ +4，魅力 +5，声望 +6 |
| `lucky_canteen_card` | 幸运饭卡贴 | 玄学 | 75 | 默认 50% | 运气 +7 |
| `academy_fountain_pen` | 学院派钢笔 | 学习 | 150 | 75 | IQ +5，声望 +5，心态 +2 |
...
普通道具新增、调价或改效果只需要编辑 `zjus-backend/world/items.json`，然后运行世界数据校验。完整开发流程见[游戏设定维护](/dev/world-data)。
